...
# ITEMS
# - items in kamer als je dood gaat zijn weg en droppen in de hal - MARTIJN
...
def death_menu_selections():
  player.location = 'schoolplein'
  player.inventory = []
  rooms['Ik kom mijn fiets ophalen, die roze daar'][ITEMS].append('fiets')
  rooms['kantine'][ITEMS].append('wafel')
  rooms['kantine'][ITEMS].append('hendeltje')
  rooms['hier heb je de hendel'][ITEMS].append('legoblokje')
  rooms['ga naar het gestamp'][ITEMS].append('briefje met code')
  rooms['zilveren boek'][ITEMS].append('zilveren boek')
  rooms['gouden boek'][ITEMS].append('gouden wiskundeboek')
  option = input ("> ")
  if option.lower() == ("ja"):
    print_location()
  elif option.lower() == ("nee"):
